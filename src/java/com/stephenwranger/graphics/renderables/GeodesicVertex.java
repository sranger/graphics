...
public class GeodesicVertex extends Vertex {
   ...
   public GeodesicVertex(final Tuple3d baseVertex, final Tuple3d vertex, final Tuple3d normal, final Tuple2d texCoord, final Color4f color, final Tuple3d lonLatAlt) {
