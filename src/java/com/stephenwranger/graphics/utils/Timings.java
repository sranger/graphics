...
public class Timings {
   ...
   public String toString() {
      ...
      for(final Entry<String, Timing> entry : this.timings.entrySet()) {
         ...
         sb.append(entry.getKey()).append(": ").append(TimeUtils.formatNanoseconds((long) timing.getAverageTiming())).append("(")
            .append(TimeUtils.formatNanoseconds(timing.getMinTiming())).append(", ")
            .append(TimeUtils.formatNanoseconds(timing.getMaxTiming())).append(")\n");
      }
