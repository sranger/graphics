...
public class Matrix3d {
   ...
   public Matrix3d(final Tuple3d column0, final Tuple3d column1, final Tuple3d column2) {
      this.set(column0, column1, column2);
   }
   ...
   public double[] multiply(final double[] in) {
      ...
      result[0] = (this.m[0] * in[0]) + (this.m[3] * in[1]) + this.m[6];
      result[1] = (this.m[1] * in[0]) + (this.m[4] * in[1]) + this.m[7];
      result[2] = (this.m[2] * in[0]) + (this.m[5] * in[1]) + this.m[8];
   ...
   public Matrix3d multiply(final Matrix3d other) {
      ...
      this.set(n00, n01, n02, n10, n11, n12, n20, n21, n22);
      return this;
   }
   ...
   public void set(final Tuple3d column0, final Tuple3d column1, final Tuple3d column2) {
      this.set(column0.x, column0.y, column0.z,
